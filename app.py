...
start_date = st.sidebar.date_input("Project Start Date", default_date)
...
if analysis_mode == "Demand Scheduling (Fixed Deadlines)":
    ...
    default_deadlines = pd.DataFrame({
        ...
        "Earliest Start Day": [0] * len(unique_jobs_list), # Default is 0 (start immediately)
    ...
    # Create dictionaries for both bounds
